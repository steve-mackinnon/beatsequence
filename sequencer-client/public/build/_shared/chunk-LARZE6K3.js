...
var Link = /* @__PURE__ */ React2.forwardRef(function LinkWithRef(_ref4, ref) {
  ...
  return /* @__PURE__ */ React2.createElement("a", _extends4({}, rest, {
    href,
...
function useFormAction(action, _temp2) {
  ...
  let path = _extends4({}, useResolvedPath(resolvedAction, {
    relative
  }));
  let location = useLocation();
  if (action == null) {
    ...
    if (redirect2) {
      if (state.transition.type === "actionReload" || isActionRedirectLocation(location)) {
        ...
        let locationState = {
          isRedirect: true,
          type: "loader",
          setCookie: redirect2.setCookie || ((_location$state = location.state) === null || _location$state === void 0 ? void 0 : _location$state.setCookie) === true
        };
        init.onRedirect(redirect2.location, locationState);
      }
      return;
...
function RemixEntry({
  ...
  let clientRoutes = React4.useMemo(() => createClientRoutes(manifest.routes, routeModules, RemixRoute), [manifest, routeModules]);
  let [clientState, setClientState] = React4.useState(entryComponentDidCatchEmulator);
...
function RemixRoute({
  ...
  let element = Component2 ? /* @__PURE__ */ React4.createElement(Component2, null) : /* @__PURE__ */ React4.createElement(DefaultRouteComponent, {
    id
  });
  let context = {
    data,
...
var NavLink2 = /* @__PURE__ */ React4.forwardRef(({
  ...
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement(NavLink, _extends2({
    ref: forwardedRef,
    to
...
var Link2 = /* @__PURE__ */ React4.forwardRef(({
  ...
  let href = useHref(to);
  let [shouldPrefetch, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement(Link, _extends2({
    ref: forwardedRef,
    to
  }, props, prefetchHandlers)), shouldPrefetch ? /* @__PURE__ */ React4.createElement(PrefetchPageLinks, {
    page: href
...
function PrefetchPageLinks({
  ...
  let matches = React4.useMemo(() => matchClientRoutes(clientRoutes, page), [clientRoutes, page]);
  if (!matches) {
    console.warn(`Tried to prefetch ${page} but no routes matched.`);
    return null;
  }
  return /* @__PURE__ */ React4.createElement(PrefetchPageLinksImpl, _extends2({
    page,
    matches
  }, dataLinkProps));
}
...
function PrefetchPageLinksImpl({
  ...
  let newMatchesForData = React4.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, location, "data"), [page, nextMatches, matches, location]);
  let newMatchesForAssets = React4.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, location, "assets"), [page, nextMatches, matches, location]);
  ...
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ React4.createElement("link", _extends2({
    key: href,
    rel: "prefetch",
    as: "fetch",
    href
  }, linkProps))), moduleHrefs.map((href) => /* @__PURE__ */ React4.createElement("link", _extends2({
    key: href,
    rel: "modulepreload",
    href
  }, linkProps))), styleLinks.map((link) => /* @__PURE__ */ React4.createElement("link", _extends2({
    key: link.href
  }, link))));
}
var Form2 = /* @__PURE__ */ React4.forwardRef((props, ref) => {
  return /* @__PURE__ */ React4.createElement(FormImpl2, _extends2({}, props, {
    ref
  }));
});
...
var FormImpl2 = /* @__PURE__ */ React4.forwardRef(({
  ...
  return /* @__PURE__ */ React4.createElement("form", _extends2({
    ref: forwardedRef,
    method: formMethod,
    action: formAction,
    encType,
...
function RemixBrowser(_props) {
  ...
  let [state, dispatch] = React5.useReducer((_, update) => update, {
    action: history.action,
    location: history.location
  });
  React5.useLayoutEffect(() => history.listen(dispatch), [history]);
...
//# sourceMappingURL=/build/_shared/chunk-LARZE6K3.js.map
